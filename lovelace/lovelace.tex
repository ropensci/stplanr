...
\CRANpkg{stplanr}, alongside other open source projects,
...
This can be used to generate heatmaps of a road network showing the most common routes such as in Figure \ref{fig:nyc-bicycle-data} (see \href{https://github.com/ropensci/stplanr/issues/194}{issue 194} for details).

...
Another desirable direction of travel is towards better support for `Big Data'.
We demonstrated functions for data access, the creation
and visualisation of OD data allocated
to the route network, and modelling travel catchment areas.

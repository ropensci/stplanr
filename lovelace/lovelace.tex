...
examples of this are the \CRANpkg{osmdata} and the Python package
\href{https://github.com/gboeing/osmnx}{OSMnx}, for downloading and processing
open access transport datasets from OpenStreetMap.}

...
The \textbf{stplanr} package provides such tools, with an emphasis on spatial transport data.
...
the incumbent approach based on expensive, proprietary and difficult-to-use products.
}

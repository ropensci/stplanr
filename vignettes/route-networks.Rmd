...
r3 = tm_shape(rnet3, bbox = bb) +
  tm_lines(col = "value", lwd = "value", palette = "viridis", scale = 20, alpha = 0.5, breaks = b) +
  tm_layout(legend.show = FALSE)
m6 = tm_shape(sample_routes, bbox = bb) +
  tm_lines(col = "value", lwd = "value", palette = "viridis", scale = 20, alpha = 0.5, breaks = b) +
  tm_layout(legend.show = FALSE)
r6 = tm_shape(rnet, bbox = bb) +
  tm_lines(col = "value", lwd = "value", palette = "viridis", scale = 40, alpha = 0.5, breaks = b) +
  tm_layout(legend.show = FALSE) 

...
Please let me know of any new OD data features you'd like to see in the package.
I'd be very interested to know how you use the package, so please let me know if you use the functions described here via email, GitHub issues or, for academic work, by citing the stplanr paper.
Thanks for reading!

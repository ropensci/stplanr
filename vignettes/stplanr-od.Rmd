...
- An excellent introduction to modelling and visualising OD data in the [introductory vignette](https://cran.r-project.org/web/packages/flows/vignettes/flows.html) of the `flows` R package.

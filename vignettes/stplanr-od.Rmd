...
OD data can also bee represented as an 'OD matrix', as illustrated below withe the **stplanr** function `od_to_odmatrix()`:
...
Intead of creating a new column for each *OD pair*, this matrix representation creates a new row for each *zone of origin*.

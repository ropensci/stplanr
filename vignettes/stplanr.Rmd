...
We use **sp** and **sf** because these support the range of vector data formats common in transport planning (points, lines, zones). See [github.com/edzer/sfr](https://github.com/edzer/sfr) and the [**sf** vignettes](https://github.com/edzer/sfr/blob/master/vignettes/sf1.Rmd) for details.

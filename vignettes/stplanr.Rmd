...
The package was reviewed through the rOpenSci package review process (see here for the details) and the package is now hosted on their site. See the website at [ropensci.github.io/stplanr](https://ropensci.github.io/stplanr/).
...
Steps to set-up a suitable R/RStudio environment are described in the package's [README](https://ropensci.github.io/stplanr/#installation).
...
A more complete list of functions in the package can be found here: https://ropensci.github.io/stplanr/reference/index.html.

...
To re-cap, these are the package versions we'll be using in this post (run these lines if you want to reproduce the results)
...
Which was aggregated using functions in the **sf** package.
It was found that

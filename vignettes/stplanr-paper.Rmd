...
These allocate a single OD pair, represented as a text string to be 'geo-coded' by Google or a set of coordinates representing origins and destinations, as illustrated below via [CycleStreets.net API](http://www.cyclestreets.net/api/) (you must request

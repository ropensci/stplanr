...
It is a small sample of desire lines and, we time is explored, we find that the 'quietness diversion factor with respect to time' ($QDF_t$) is slightly larger:
...
Based on the right-hand panel in Figure \ref{fig:euclidfastest}, there is a clear negative relationship

...
This includes the `read_table_builder` function for importing data from the Australian Bureau of Statistics (ABS) and the `dl_stats19` and `format_stats19_*` functions for downloading and importing road traffic casualty data, a brief example of which is illustrated below.

```{r, eval=FALSE}
dl_stats19() # automatically downloads and extracts stats19 data
```

```
#> [1] "Data saved at: /tmp/Accidents0514.csv"  "Data saved at: /tmp/Casualties0514.csv"
#> [3] "Data saved at: /tmp/Vehicles0514.csv"  
